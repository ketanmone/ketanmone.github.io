...
It demonstrates how I applied theoretical frameworks, collaborated with peers, and developed both qualitative and quantitative risk assessments for a realistic business scenario — *Pampered Pets Ltd*.  
...
## 2️⃣ Unit 6 — Team Status Document (Pampered Pets)

**Project:** *Pampered Pets – Risk Assessment and Recommendations* (Team Cipher)  
...
- Drafted the Phase 1–4 mitigation roadmap (IT hygiene → E-commerce → Inventory → Supply chain).  
...
📄 **Download:** [Risk Assessment – Pampered Pets (Team Cipher)](./units/unit06/Risk_Assessment_PamperedPets_TeamCipher.pdf)

---

## 3️⃣ Unit 11 — Individual Executive Summary (Quantitative Risk Modelling & BC/DR)
...
- **Failure Mode and Effects Analysis (FMEA):** to rank failure modes using severity × occurrence × detection.  
- **Frameworks referenced:** ISO 31000, ISO 22301, ISO/IEC 27001, and GDPR Article 32.  

**Key Results:**  
- Cyber-attack probability: 28 % (High) → top priority control area.  
- Automation error: 14 % (Moderate) → mitigated through predictive maintenance.  
...
- RTO ≤ 60 s  |  RPO ≤ 60 s  |  Availability = 24 / 7 / 365.  
...
📄 **Download:** [Executive Summary – Pampered Pets (Individual)](./units/unit11/Executive_Summary_PamperedPets.pdf)

---

## 4️⃣ Learning Outcomes Summary  
...
## 5️⃣ Reflection (Rolfe et al., 2001 – What / So What / Now What)

### **What? – Description of my learning and project experience**
...
Designing a **multi-cloud BC/DR architecture** taught me to merge technical precision with strategic foresight — ensuring that resilience isn’t just theoretical but operationally achievable.

---

### **So What? – Critical analysis and personal insight**

Initially, I saw risk management as primarily documentation.  
However, developing the simulation model showed me that **risk is dynamic** — a moving probability shaped by technology, people, and process maturity.  
...
Balancing different working styles required empathy and structure. Using GitHub for version control and Microsoft Teams for coordination improved my ability to manage distributed teamwork — an essential skill in cybersecurity operations.  

Critically reviewing frameworks revealed why adoption often fails: organisational culture, budget constraints, and “check-box compliance.”  
I connected this to **Renn et al. (2021)** who argue that sustainable digitalisation must embed ethics and human oversight.  
This influenced my stance that resilience must include **human-in-the-loop** decision-making — ensuring automation never replaces accountability.  
...
### **Now What? – Application and future professional growth**
...
On a personal level, the module strengthened my self-efficacy. I now view security not as avoiding failure but **engineering graceful recovery** — transforming crisis into competence.  
Resilience, therefore, becomes a continuous practice aligned with both business goals and ethical responsibility.

---

## 6️⃣ References (Harvard Style, 2020 – 2025)
...
Google SRE (2023) *Site Reliability Workbook (2nd ed.)*. O’Reilly Media.  
...
ISO (2023) *ISO 22301:2019 Security and Resilience — Business Continuity Management Systems (Updated Guidance)*. Geneva: ISO.  
...
AWS (2023) *Well-Architected Framework – Reliability & Resilience Pillar*. Amazon Web Services.   
